...
export interface AiMemoryConfig {
  ...
  /** Configuration for LLM-based summarization (ai-memory summarize) */
...
export interface Metadata {
  ...
  /** Files with AI-generated summaries (from ai-memory summarize) */
 ...
 * Generated by `ai-memory summarize`. Committed to git so the whole team shares them.
...
/**
 * Stored in ~/.ai-memory-cache/<projectId>/embeddings.json.
...
/**
 * .ai-memory/knowledge/entries.json
